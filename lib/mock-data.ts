...
// DRR (Quality Rework) Issues visible to GA Engineer
export const drrIssuesForGAEngineer = [
  {
    id: 101,
    date: '2026-04-23',
    shift: 'A',
    sector: 'TRIM',
    code: '45',
    name: 'Qaynash ekilmasa qolgan',
    count: 4,
    factor: 23,
    submittedBy: 'Rustam Usmonov',
    status: 'ochiq',
    module: 'DRR',
    gaRelated: true,
    engineerNote: 'GA bilan bog\'liq - detal konfiguratsiyasi noto\'g\'ri',
    rootCause: '',
    action: '',
  },
  {
    ...
    module: 'DRR',
    gaRelated: true,
    engineerNote: 'GA master bilan koordinatsiya olindi',
    rootCause: 'Oldingi sexdan kelgan noto\'g\'ri detal',
    action: 'Master parametrlarini tekshirish',
  },
]

// DRL (Defect Cost) Issues visible to GA Engineer
export const drlIssuesForGAEngineer = [
  {
    id: 201,
    date: '2026-04-23',
    shift: 'D',
  ...
  },
  {
    ...
    module: 'DRL',
    gaRelated: true,
    engineerNote: 'GA ichidan kelib chiqqan, tezkorlik bilan hal qilish kerak',
    rootCause: 'GA jarayonidagi sifatsizlik',
    action: 'GA prosessini qayta tekshirish',
  },
]
