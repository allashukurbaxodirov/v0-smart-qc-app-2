...
import { drrDefectsByShop } from '@/lib/mock-data'
...
export default function DRRPage() {
  ...
  if (selectedShop) {
    ...
    return (
      <div className="min-h-screen bg-background">
        <PageHeader
          title={selectedShop}
          description="DRR nuqsonlari va xavflilik faktorlari"
          breadcrumbs={[
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Page Header */}
      <PageHeader
        title="DRR aniqlangan muammolar"
        description="Design Requirement Review - Taqsimot bo'yicha nuqsonlar tahlili"
        breadcrumbs={[
          { label: 'Dashboard', href: '/dashboard' },
          { label: 'DRR' },
        ]}
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="bg-card border border-primary/30 rounded-xl p-8 bg-primary/5">
          <p className="text-sm text-muted-foreground mb-2">DRR aniqlangan muammolar umumiy soni</p>
