...
import { cmmDefectsByShop } from '@/lib/mock-data'
...
export default function CMMPage() {
  ...
  const getTotalDefects = () => {
    ...
    let total = 0
    shops.forEach((shop) => {
      const defects = cmmDefectsByShop[shop] || []
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="bg-card border border-primary/30 rounded-xl p-8 bg-primary/5">
          <p className="text-sm text-muted-foreground mb-2">CMM aniqlangan muammolar umumiy soni</p>
