...
const FACTOR_META = [
  { key: 'f50', label: 'Faktor 50', textCls: 'text-critical',   borderCls: 'border-critical', bgCls: 'bg-critical/5'  },
  { key: 'f20', label: 'Faktor 20', textCls: 'text-warning',    borderCls: 'border-warning',  bgCls: 'bg-warning/5'   },
  { key: 'f10', label: 'Faktor 10', textCls: 'text-blue-500',   borderCls: 'border-blue-500', bgCls: 'bg-blue-500/5'  },
  { key: 'f5',  label: 'Faktor 5',  textCls: 'text-success',    borderCls: 'border-success',  bgCls: 'bg-success/5'   },
] as const
...
export default function D20Page() {
  ...
  const records = allRecords.filter((r) => r.type === 'd20')
  ...
  if (selectedShop) {
    ...
    return (
      <div className="min-h-screen bg-background">
        <PageHeader
          title={`D20 — ${selectedShop}`}
          description="Sehdan kelgan D20 nuqsonlari • Faktor bo'yicha tahlil"
          breadcrumbs={[
            { label: 'Dashboard', href: '/dashboard' },
            { label: 'D20 Daily Board', href: '/dashboard/d20' },
            { label: selectedShop },
          ]}
        />
                  ...
                  {defects.length === 0 ? (
                    <tr>
                      <td colSpan={5} className="px-5 py-10 text-center text-muted-foreground">
                        Bu sehda hali D20 nuqsoni kiritilmagan
                      </td>
                    </tr>
                  ) : (
                    defects.map((d, i) => (
  ...
  return (
    <div className="min-h-screen bg-background">
      <PageHeader
        title="D20 Daily Board"
        description="D20 nuqsonlari • Sehlar va faktorlar bo'yicha taqsimot"
        breadcrumbs={[
          { label: 'Dashboard', href: '/dashboard' },
          { label: 'D20 Daily Board' },
        ]}
      />
      ...
      <div className="p-6 space-y-6">
          ...
          <div className="bg-card border border-border rounded-xl p-6">
            <div className="mb-6">
              ...
              <p className="text-xs text-muted-foreground mt-0.5">
                Sehlar bo&apos;yicha D20 nuqsonlari — faktorlarga ko&apos;ra
              </p>
            </div>
        ...
        {!loading && records.length === 0 && (
          <div className="bg-card border border-border rounded-xl p-12 text-center">
            <p className="text-muted-foreground text-sm">Hali D20 nuqsoni kiritilmagan.</p>
            <p className="text-muted-foreground text-xs mt-1">D20 Admin panelidan yangi yozuv qo&apos;shing.</p>
          </div>
        )}
