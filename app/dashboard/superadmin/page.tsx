...
const ROLES: {
  ...
  { value: 'press_engineer',     label: 'Press Shop Muhandis', color: 'text-orange-600',  bg: 'bg-orange-500/15 border-orange-500/40',  needsShift: false, needsShop: true  },
  { value: 'paint_engineer',     label: 'Paint Shop Muhandis', color: 'text-fuchsia-600', bg: 'bg-fuchsia-500/15 border-fuchsia-500/40',needsShift: false, needsShop: true  },
  { value: 'sqe_engineer',       label: 'SQE Muhandis',        color: 'text-teal-600',    bg: 'bg-teal-500/15   border-teal-500/40',    needsShift: false, needsShop: false },
  { value: 'qe_engineer',        label: 'QE Muhandis',         color: 'text-cyan-600',    bg: 'bg-cyan-500/15   border-cyan-500/40',    needsShift: false, needsShop: false },
  { value: 'pe_engineer',        label: 'PE Muhandis',         color: 'text-lime-600',    bg: 'bg-lime-500/15   border-lime-500/40',    needsShift: false, needsShop: false },
