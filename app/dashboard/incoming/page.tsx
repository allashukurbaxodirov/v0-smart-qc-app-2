...
import { incomingDefectsByShop } from '@/lib/mock-data'
...
export default function IncomingPage() {
  ...
  const getTotalDefects = () => {
    ...
    let total = 0
    shops.forEach((shop) => {
      const defects = incomingDefectsByShop[shop] || []
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="bg-card border border-primary/30 rounded-xl p-8 bg-primary/5">
          <p className="text-sm text-muted-foreground mb-2">Kiruvchi muammolar umumiy soni</p>
