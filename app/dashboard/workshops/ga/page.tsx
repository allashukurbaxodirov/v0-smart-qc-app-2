      ...
      <div className="p-6 space-y-6">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {['TRIM', 'SHOSSE', 'FINAL', 'SUB'].map((sector) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <h3 className="text-lg font-bold text-foreground">{sector}</h3>
                  ...
                  <div className="mb-4">
                    <div className="w-full bg-muted/50 rounded-full h-2 overflow-hidden">
                      <div
                        className={`h-2 rounded-full transition-all ${getProgressBarColor(data.color)}`}
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-sm font-semibold text-foreground">{data.percentage.toFixed(1)}%</span>
                    <span className="text-xs text-muted-foreground">{data.shift} smena</span>
                  </div>
                </button>
              )
            })}
