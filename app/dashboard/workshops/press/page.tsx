...
import { pressSectors, pressSectorDetails } from '@/lib/mock-data'
import { ChevronLeft } from 'lucide-react'
import { Button } from '@/components/ui/button'
import { Badge } from '@/components/ui/badge'
import Link from 'next/link'

export default function PressDrilldownPage() {
  const [activeShift, setActiveShift] = useState('A')
  const [selectedSector, setSelectedSector] = useState<string | null>(null)

  const shopData = pressSectors['PRESS SHOP']
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="p-6 space-y-6">
        ...
        {selectedSector && pressSectorDetails[selectedSector as keyof typeof pressSectorDetails] && (
              ...
              <div className="p-6 space-y-6">
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    {pressSectorDetails[selectedSector as keyof typeof pressSectorDetails]?.topDefects.map(
                      (defect, idx) => (
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {pressSectorDetails[selectedSector as keyof typeof pressSectorDetails]?.rootCauses.map(
                      (cause, idx) => (
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {pressSectorDetails[selectedSector as keyof typeof pressSectorDetails]?.actions.map(
                      (action, idx) => (
